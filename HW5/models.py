...
class DCGenerator(nn.Module):
    def __init__(self, noise_size, conv_dim):
        ...
        # self.deconv3 = deconv(...)
        # self.deconv4 = deconv(...)
        self.deconv1 = deconv(in_channels=noise_size, out_channels=conv_dim*4,kernel_size=4, stride=2, padding=0)
        self.deconv2 = deconv(in_channels=conv_dim*4, out_channels=conv_dim*2, kernel_size=4, stride=2, padding=1)
        self.deconv3 = deconv(in_channels=conv_dim*2, out_channels=conv_dim, kernel_size=4, stride=2, padding=1)
...
class CycleGenerator(nn.Module):
    ...
    def __init__(self, conv_dim=64, init_zero_weights=False):
        ...
        self.deconv1 = deconv(in_channels=conv_dim*2, out_channels=conv_dim, kernel_size=4, stride=2, padding=1)
        self.deconv2 = deconv(in_channels=conv_dim, out_channels=3, kernel_size=4, stride=2, padding=1)
...
class DCDiscriminator(nn.Module):
    ...
    def __init__(self, conv_dim=64):
        ...
        self.conv4 = conv(in_channels=conv_dim*4, out_channels=1, kernel_size=4, stride=2, padding=0, batch_norm=False)
